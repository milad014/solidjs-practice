...
const rule = {
    ...
    create(context) {
        ...
        return {
            ...
            Property(node) {
                var _a, _b, _c, _d;
                if (((_a = context.options[0]) === null || _a === void 0 ? void 0 : _a.warnOnSpread) &&
                    ((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type) === "ObjectExpression" &&
                    ((_c = node.parent.parent) === null || _c === void 0 ? void 0 : _c.type) === "JSXSpreadAttribute" &&
                    ((_d = node.parent.parent.parent) === null || _d === void 0 ? void 0 : _d.type) === "JSXOpeningElement") {
                            ...
                            context.report({
                                ...
                                *fix(fixer) {
                                    ...
                                    yield fixer.remove(node.parent.properties.length === 1
                                        ? node.parent.parent
                                        : node);
                                    if ((commaAfter === null || commaAfter === void 0 ? void 0 : commaAfter.value) === ",") {
