...
const rule = {
    ...
    create(context) {
        ...
        return {
            CallExpression(node) {
                var _a, _b, _c;
                const callOrChain = ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === "ChainExpression" ? node.parent : node;
                if (((_b = callOrChain.parent) === null || _b === void 0 ? void 0 : _b.type) === "JSXExpressionContainer" &&
                    ((_c = callOrChain.parent.parent) === null || _c === void 0 ? void 0 : _c.type) === "JSXElement") {
