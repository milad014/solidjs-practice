    ...
    create(context) {
        ...
        const logicalExpressionHandler = (node) => {
            if (node.operator === "&&" && EXPENSIVE_TYPES.includes(node.right.type)) {
                context.report({
                    ...
                    fix: (fixer) => {
                        var _a, _b;
                        return fixer.replaceText(((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === "JSXExpressionContainer" &&
        ...
        return {
            JSXExpressionContainer(node) {
                var _a;
                if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) !== "JSXElement") {
                    return;
                }
