    ...
    create(context) {
        ...
        const checkForTrackedScopes = (node) => {
            ...
            if (node.type === "JSXExpressionContainer") {
                ...
                else if (((_f = node.parent) === null || _f === void 0 ? void 0 : _f.type) === "JSXElement" && (0, utils_2.isFunctionNode)(node.expression)) {
                        ...
                        if (arg1) {
                            ...
                            if (owner) {
                                ...
                                if (decl &&
                                    ...
                                    ((_g = decl.node.init) === null || _g === void 0 ? void 0 : _g.type) === "CallExpression" &&
                ...
                if (((_h = node.init) === null || _h === void 0 ? void 0 : _h.type) === "CallExpression" && node.init.callee.type === "Identifier") {
                        ...
                        if (track) {
                            for (const reference of track.references) {
                                if (!reference.init &&
                                    ...
                                    ((_j = reference.identifier.parent) === null || _j === void 0 ? void 0 : _j.type) === "CallExpression" &&
