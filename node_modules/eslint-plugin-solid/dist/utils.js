...
function appendImports(fixer, sourceCode, importNode, identifiers) {
    ...
    if (importNode.specifiers.length === 0) {
        ...
        if ((maybeBrace === null || maybeBrace === void 0 ? void 0 : maybeBrace.value) === "{") {
...
function insertImports(fixer, sourceCode, source, identifiers, aboveImport, isType = false) {
    ...
    const firstImport = aboveImport !== null && aboveImport !== void 0 ? aboveImport : programNode.body.find((n) => n.type === "ImportDeclaration");
    if (firstImport) {
        return fixer.insertTextBeforeRange(((_a = (0, exports.getCommentBefore)(firstImport, sourceCode)) !== null && _a !== void 0 ? _a : firstImport).range, `import ${isType ? "type " : ""}{ ${identifiersString} } from "${source}";\n`);
    }
...
function removeSpecifier(fixer, sourceCode, specifier, pure = true) {
    ...
    if ((maybeComma === null || maybeComma === void 0 ? void 0 : maybeComma.value) === ",") {
